<%-- 
    Document   : FormBitacora
    Created on : 14/06/2018, 11:37:11 AM
    Author     : jllpz
--%>
...
<!DOCTYPE html>
    ...
    <% HttpSession sesion = request.getSession();
       ...
       sesion.setAttribute("proyect", sesion.getAttribute("proyect"));
    %>
      ...
      <div class="container">
        ...
        <form:form method="POST" commandName="datos"> 
            <div class="control-group">
                 ...
                 <input name="proyecto_id" class="form-control" value="<%=p.getId()%>" disabled="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Municipio o Delegación: </label>
                 <input class="form-control" value="<%=p.getMunicipio()%>" disabled="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Tipo de Obra: </label>
                 <input class="form-control" value="<%=p.getTipoObra()%>" disabled="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Fecha del proyecto: </label>
                 <input class="form-control" value="<%=p.getCreated()%>" disabled="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Ubicación: </label>
                 <input class="form-control" value="<%=p.getUbicacion()%>" disabled="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Propietario: </label>
                 <input class="form-control" value="<%=p.getPropietario()%>" disabled="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Id Usuario: </label>
                 <input name="usuario_id" class="form-control" value="<%=user.getId()%>" disabled="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Nombre Bitacora: </label>
                 <form:input path="nombre" cssClass="form-control" required="true"/>
             </div>
             <br>
            <div class="control-group">
                 <label style="font-size: 25px;">M2: </label>
                 <input name="m2" class="form-control" required="true"/>
             </div>
             <br>
            <div class="control-group">
                 <label style="font-size: 25px;">Comentario: </label>
                 <textarea name="contenido" class="form-control" required="true"></textarea>
           </div>
             <br>
            <div class="control-group">
