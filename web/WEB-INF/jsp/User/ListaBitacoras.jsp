<%-- 
    Document   : ListaBitacoras
    Created on : 14/06/2018, 11:35:45 AM
    Author     : jllpz
--%>
...
<html>
  ...
  <section class="portfolio" id="portfolio">
    <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Bitacoras</h2>
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <br>
              <b class="mb-5" style="font-size: 25px;">Nombre Bitacora: </b><p class="mb-5" style="font-size: 25px;"><c:out value="${c.nombre}"/></p>
              <b class="mb-5" style="font-size: 25px;">Id Usuario: </b><p class="mb-5" style="font-size: 25px;"><c:out value="${c.usuario_id}"/></p>
              <b class="mb-5" style="font-size: 25px;">Creado: </b><p class="mb-5" style="font-size: 25px;"><c:out value="${c.created}"/></p>
              <b class="mb-5" style="font-size: 25px;">M2: </b><p class="mb-5" style="font-size: 25px;"><c:out value="${c.m2}"/></p>
              <b class="mb-5" style="font-size: 25px;">Id Proyecto: </b><p class="mb-5" style="font-size: 25px;"><c:out value="${c.proyecto_id}"/></p>
              <b class="mb-5" style="font-size: 25px;">Comentario: </b><p class="mb-5" style="font-size: 25px;"><c:out value="${c.contenido}"/></p>
 
              <a class="btn btn-primary" href="<c:url value="ModificarBitacora.htm?id=${c.id}"/>">
                <i class="fa fa-code"></i>
                Modificar Bitacora</a>
