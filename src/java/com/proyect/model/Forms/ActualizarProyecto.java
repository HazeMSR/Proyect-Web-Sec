 ...
 */
@Controller
@RequestMapping("ModificarProyecto.htm")
public class ActualizarProyecto {
    ...
    public ModelAndView form(HttpServletRequest request) throws SQLException{
        ...
        Proyectos proyectoAux = new Proyectos();
        proyect.setId(Integer.parseInt(request.getParameter("id")));
        proyectoAux = dao.Read(proyect);
        
        
        HttpSession sesion = request.getSession();
        sesion.setAttribute("sesion", sesion.getAttribute("sesion"));
        
        mav.setViewName("User/ActualizarProyecto");
        mav.addObject("datos", proyectoAux);
        return mav;
    }
