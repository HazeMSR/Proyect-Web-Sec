<%-- 
    ...
    Created on : 18/06/2018, 08:20:18 AM
    Author     : jllpz
--%>
      ...
      <div class="container">
        ...
        <form:form method="POST" commandName="datos"> 
             ...
             <div class="control-group">
                 ...
                 <input name="nombre" class="form-control" required="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Arquitecto: </label>
                 <input name="arqui" class="form-control" required="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Tipo de Obra: </label>
                 <input name="tipoObra" class="form-control" required="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Municipio o Delegación: </label>
                 <input name="municipio" class="form-control" required="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Ubicación: </label>
                 <input name="ubicacion" class="form-control" required="true"/>
             </div>
             <br>
             <div class="control-group">
                 <label style="font-size: 25px;">Propietario: </label>
                 <input name="propietario" class="form-control" required="true"/>
             </div>
             <br>
            <div class="control-group">
