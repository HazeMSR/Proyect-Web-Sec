<%-- 
    Document   : Registro
    Created on : 16/06/2018, 06:39:37 PM
    Author     : jllpz
--%>
...
<!DOCTYPE html>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
          <a class="navbar-brand js-scroll-trigger" href="<c:url value="inicio.htm"/>">Constructora PRO</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<c:url value="login.htm"/>">Login</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
                <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<c:url value="registro.htm"/>">Registrar</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <form:form method="POST" commandName="datos"> 
             <div class="control-group">
                 <%-- <form:label path="nombre" cssStyle="font-size: 25px;">Nombre: </form:label>
<form:input path="nombre" cssClass="form-control"/>--%>
                 <label style="font-size: 25px;">Nombre: </label>
                 <input name="nombre" class="form-control" placeholder="Ingrese  Nombre" required="true"/>
             </div>
             <br>
             <div class="control-group">
<%--                 <form:label path="apellidos" cssStyle="font-size: 25px;">Apellidos: </form:label>
                      <form:input path="apellidos" cssClass="form-control"/>--%>
                 <label style="font-size: 25px;">Apellidos: </label>
                 <input name="apellidos" class="form-control" placeholder="Ingrese  Apellidos" required="true"/>
             </div>
             <br>
             <div class="control-group">
<%--                 <form:label path="email" cssStyle="font-size: 25px;">Correo: </form:label>
                      <form:input path="email" cssClass="form-control"/>--%>
                 <label style="font-size: 25px;">Email: </label>
                 <input name="email" class="form-control" placeholder="Ingrese Email   Ej.  nombre.apellido@mail.com" required="true"/>
             </div>
             <br>
            <div class="control-group">
 <%--                   <form:label path="pass" cssStyle="font-size: 25px;">Password: </form:label>
             ...
             <br>
            <div class="control-group">
                      <label style="font-size: 25px;">Confirme Password: </label>
                      <input type="password" name="passw" class="form-control"/>
             </div>
             <br>
            <div class="control-group">
                <%--                      <form:label path="website" cssStyle="font-size: 25px;">WebSite: </form:label>
<form:input path="website" cssClass="form-control"/>--%>
                 <label style="font-size: 25px;">WebSite: </label>
                 <input name="website" class="form-control" placeholder="Ingrese  WebSite   Ej.  http://www.misitio.com/hola/" required="true"/>
             </div>
             <br>
             <div class="control-group">
            ...
            <div class="control-group">
             ...
             <br>
             <br>
                <input type="submit" value="Registrar" class="btn btn-primary btn-xl">
