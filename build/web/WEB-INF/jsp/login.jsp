<%-- 
    Document   : login
    Created on : 14/06/2018, 11:03:34 AM
    Author     : jllpz
--%>
      ...
      <div class="container">
        ...
        <form:form method="POST" commandName="datos"> 
             <div class="control-group">
                 ...
                 <label style="font-size: 25px;">Correo: </label>
...
<form:password path="pass" cssClass="form-control"/>--%>
             ...
             <div class="control-group">
                 ...
                 <input name="cap" id="captcha" value="" hidden="true"/>
             </div>       
            <div class="control-group">
             ...
             <br>
             <br>
                <input type="submit" value="Ingresar" class="btn btn-primary btn-xl">
